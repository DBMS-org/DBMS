...
namespace Domain.Entities.MachineManagement
{
    public class Machine : BaseAuditableEntity
    {
        ...
        public MachineStatus Status { get; private set; } = MachineStatus.Active;
        ...
        public static Machine Create(string name, string type, string model, string manufacturer, string serialNumber, int projectId)
        {
            return new Machine
            {
                Name = name,
