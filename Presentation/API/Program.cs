...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("ManageDrillData", policy => policy.RequireRole("Admin", "Administrator", "BlastingEngineer", "Operator"));
    options.AddPolicy("ManageProjectSites", policy => policy.RequireRole("Admin", "Administrator", "BlastingEngineer", "Operator"));
